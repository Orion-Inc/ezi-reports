                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input id="student_code" name="student_code" type="text" class="form-control input-sm" readonly="" placeholder="Student Code" data-rule-required="true">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="student_class" class="form-control input-sm" id="student_class" data-rule-required="true">
                                                    <option value="" readonly="" selected="">Select Course First</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input name="guardian_occupation" type="text" class="form-control input-sm" placeholder="Occupation" data-rule-required="true">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="guardian_telephone" type="text" class="form-control input-sm" placeholder="Telephone Number" data-rule-required="true" data-rule-digits="true" data-rule-minlength="10" data-rule-maxlength="10">
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
