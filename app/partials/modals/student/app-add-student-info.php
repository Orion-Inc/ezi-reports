                                        ...
                                        <div id="enroll_single" role="tabpanel" aria-labelledby="single_tab" class="tab-pane fade active in">
                                            <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div id ="dob" class="input-group date">
                                                                                     <input id="datepicker" type="text" class="form-control" data-rule-required="true" data-rule-date="true"><span class="input-group-addon"><span class="ti-calendar"></span></span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                ...
                                                <div class="pull-right">
                                                    <button type="button" name="btnNext" class="btn btn-sm btn-primary">Next<i class="ti-arrow-right ml-5 mr-5"></i></button>
                                                </div>
