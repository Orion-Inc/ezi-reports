...
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4">
        <div class="simple-page-form animated zoomIn" id="login-form">
            ...
            <form action="../includes/auth/change-access-key.php" method="POST">
                ...
                <div class="form-group">
                    <input name="confirm_access_key" type="password" class="form-control" placeholder="Confirm Access Code" required="" oninvalid="this.setCustomValidity('Confirm Your Access Code')" oninput="setCustomValidity('')">
                </div>
...
<div class="simple-page-footer animated zoomIn">
    <p>
        <small><?php App::ViewPartial('version', 'app') ?> </small>
    </p>
</div>